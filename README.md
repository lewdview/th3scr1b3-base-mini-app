...
NEXT_PUBLIC_DONATION_ADDRESS=0x0000000000000000000000000000000000000000
...
Set `NEXT_PUBLIC_DONATION_ADDRESS` to your wallet address to enable ETH donations in-app.
