...
const DEFAULT_DONATION_ADDRESS = '0x985606Faaad78887Df96002a3555ccf2c8640a08';
...
export const DONATION_RECIPIENT_LABEL =
  readEnvValue('NEXT_PUBLIC_DONATION_LABEL', 'th3scr1b3.eth');
export const COMMENT_FEE_ETH = readEnvValue('NEXT_PUBLIC_COMMENT_FEE_ETH', '0.0002');
export const COMMENT_RECEIVER =
  readEnvValue('NEXT_PUBLIC_COMMENT_RECEIVER', DEFAULT_DONATION_ADDRESS);
